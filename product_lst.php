                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Min. Stock To Maintain</th>
                                    <th class="text-center">Opening Quality</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $obj->p_hsn; ?></td>
                                    <td><?php echo $dbcon->GetOneRecord('tbl_uom','uom_name','id ="'.$obj->uom.'" AND del_status',0); ?></td>
                                    <td><?php echo $dbcon->GetOneRecord('tbl_category','category_name','id ="'.$obj->category_name.'" AND del_status',0);?></td>
                                    <td><?php echo $dbcon->GetOneRecord('tbl_gst','descriptions','id ="'.$obj->gst.'" AND del_status',0); ?></td>
                                    <td><?php echo $obj->min_stock_maintain; ?></td>
                                    <td><?php echo $obj->opening_qty; ?></td>
